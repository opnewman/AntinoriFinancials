                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td className="border px-4 py-2 text-right bg-blue-50">
                            {risk_metrics && risk_metrics.equity && risk_metrics.equity.volatility !== undefined ? 
                    ...
                    <tr>
                        ...
                        <td className="border px-4 py-2 text-right bg-blue-50">
                            {risk_metrics && risk_metrics.equity && risk_metrics.equity.beta !== undefined ? 
